---
name: presentacion-ventas
description: "Creates sales presentation decks with discovery integration, ROI slides, and competitive positioning. Use when you need a persuasive slide deck for sales meetings."
...
1. **Slide title** — short, benefit-oriented
2. **Visual content** — what appears on the slide (bullets, chart, image description)
3. **Talking points** — what the presenter says (not on the slide)
4. **Design notes** — layout suggestions for visual impact
