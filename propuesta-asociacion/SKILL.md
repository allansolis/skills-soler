---
name: propuesta-asociacion
description: Creates strategic partnership pitch documents with mutual value propositions, deal structures, and terms. Use this skill when a user wants to propose a joint venture, co-marketing deal, revenue share, or strategic alliance to another business.
...
6. Create a two-column value matrix:

| What You Bring | What They Gain |
|---------------|----------------|
| [Specific asset, audience, or capability] | [Specific measurable benefit] |

7. Quantify everything possible — audience size, conversion rates, revenue potential, cost savings
8. Identify the "unfair advantage" — the one thing that makes this partnership uniquely valuable vs. alternatives

### Phase 3: Draft the Proposal Document

9. Write the proposal using this structure:
...
11. Write a short outreach email to send alongside the proposal

### Phase 5: Deliver

12. Output the complete proposal document
13. Output the outreach email
14. Provide talking points for a follow-up call
