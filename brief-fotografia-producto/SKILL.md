---
name: brief-fotografia-producto
description: Creates e-commerce product photography shot lists with angles, lighting notes, and styling direction. Use this skill when a user needs to prepare for product photos, brief a photographer for e-commerce images, or plan product shots that drive conversions for their online store.
...
3. Create the core shot list (minimum 7 shots per product):
...
5. Specify lighting for each shot type:
...
7. Compile into a photographer-ready document:
...
**Product:** Hand-stitched leather bifold wallet
**Variants:** Brown, Black
**Retail:** $89
**Platforms:** Shopify (primary), Amazon (secondary)
...
- File naming: `wallet-brown-01-hero-front.jpg`, `wallet-brown-02-angle.jpg`, etc.
...
**Product:** Handmade 12oz ceramic mug, speckled glaze
**Variants:** Desert Sand, Ocean Blue, Forest Moss
**Retail:** $34
**Platforms:** Etsy, Squarespace website
...
- File naming: `mug-desert-sand-01-hero.jpg`, `mug-ocean-blue-02-angle.jpg`
