---
name: historia-exito-cliente
description: "Transforms customer successes into internal win stories with metrics, timeline, and key moments for team motivation and learning."
...
"[Customer] came to us with [problem]. After [timeframe] of [what we did], they achieved [headline result]. The key lesson: [one takeaway]."

**Win Library Entry:**
Add to a searchable document or database organized by category, date, and customer type.
