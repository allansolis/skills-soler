...
description: "Builds new customer and subscriber welcome experiences with email series, onboarding steps, and quick wins. Use when a user has new subscribers joining an email list, customers purchasing a product, or members signing up for a program and needs a structured first-impression sequence."
---
...
1. What did the person just do? (subscribed, purchased, signed up)
2. What's the #1 thing you want them to do within 7 days?
3. What's their biggest fear or doubt right now?
4. What quick win can you deliver in email 1?
5. How many emails do you want? (default: 5 emails over 7 days)
...
1. Check that email 1 delivers value with zero friction
2. Verify each email has only ONE call-to-action
3. Ensure the sequence builds — each email references the previous
4. Add conditional logic notes (e.g., "if they clicked email 2 CTA, skip email 4")
5. Include unsubscribe-friendly language in email 5
...
Subject: Your Instagram course is ready — start here
Preview: Plus the one module most students skip (don't)

> Hey [First Name],
>
> You're in! Here's everything you need to get started:
>
> **Your login:** [Course platform link]
> **Your password:** The one you set at checkout (check spam if you didn't get the confirmation)
>
...
Subject: Do this before Module 1 (5 min)
Preview: The step that makes everything else work better
...
> 2. Read your bio out loud
> 3. Ask: "Would a stranger know exactly what I do and who I help in 3 seconds?"
>
> If the answer is no, use this formula:
...
Subject: You're in — create your first project in 2 min
Preview: No setup required, just click and go

> Welcome to TaskFlow, [First Name]!
>
> Your 14-day trial is active. Here's the fastest way to see value:
>
> **Step 1:** Click here to open your dashboard → [Link]
> **Step 2:** Hit "+ New Project" and name it anything (try "Test Project")
> **Step 3:** Add 3 tasks you need to do this week
>
...
>
> Let's go,
> [Name], Co-founder @ TaskFlow

**Email 3 — Day 3:**

Subject: How Bright Studios cut their meeting time in half
Preview: They were skeptical too
