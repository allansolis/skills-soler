...
description: "Outlines fitness programs with phase structure, progression logic, exercise selection, and client modifications."
...
1. **Increase weight when** the client completes all prescribed sets and reps with good form for 2 consecutive sessions
2. **Increase weight by** 5 lbs for upper body, 10 lbs for lower body (or smallest available increment)
3. **Deload every 4th week** — reduce volume by 40% to allow recovery
4. **Do not progress if** form breaks down or the client reports pain
