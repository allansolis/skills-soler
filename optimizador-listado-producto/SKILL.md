---
name: optimizador-listado-producto
description: "Optimizes e-commerce product listings with titles, bullet points, descriptions, backend keywords, and images for Amazon, Shopify, and other platforms. Use to increase conversions."
...
**Title:** "ProChop Vegetable Dicer — 12-in-1 Food Chopper with 8 Blades, Catch Container, and Non-Slip Base — Dishwasher Safe Kitchen Prep Tool for Onions, Tomatoes, Potatoes"
**Bullet 1:** "CUTS PREP TIME BY 70% — Dice, slice, and chop vegetables in seconds instead of minutes with 8 interchangeable stainless steel blades."

## Example 2: Shopify Product Listing (Digital Course)

**Title:** "The Freelancer's Pricing Masterclass"
**Description opening:** "Stop undercharging and start earning what you're worth. This self-paced course gives you the exact frameworks, scripts, and calculators 2,000+ freelancers have used to raise their rates by an average of 40%."
