...
if (stageCount.count === 0) {
  const defaultStages = [
    ...
    { name: "Elena Respondio", order: 2, color: "#2563eb", isWon: 0, isLost: 0 },
    { name: "Interesado", order: 3, color: "#7c3aed", isWon: 0, isLost: 0 },
    { name: "Cotizacion Enviada", order: 4, color: "#8b5cf6", isWon: 0, isLost: 0 },
    { name: "Negociacion", order: 5, color: "#ea580c", isWon: 0, isLost: 0 },
    { name: "Venta Cerrada", order: 6, color: "#059669", isWon: 1, isLost: 0 },
