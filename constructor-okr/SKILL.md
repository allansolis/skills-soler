---
name: constructor-okr
description: "Creates OKR frameworks with objective setting, key result definition, scoring rubrics, and progress tracking for goal-driven businesses."
...
**Good Objective:** "Become the go-to resource for solopreneurs learning AI tools"
**Bad Objective:** "Get more website traffic" (too vague, not inspiring)

**Good Key Result:** "Publish 12 blog posts that each generate 500+ organic visits within 60 days"
**Bad Key Result:** "Write more blog posts" (not measurable)
